...
INSTANTIATE_TEST_SUITE_P(TensorExpandDimsTests, ExpandDimsTest,
                         ::testing::Values(
...
TEST_P(ExpandDimsThrowsTest, ExpandDimsThrows) { EXPECT_THROW(tensor->expand_dims(axis), std::invalid_argument); }

INSTANTIATE_TEST_SUITE_P(
    TensorExpandDimsThrowsTests, ExpandDimsThrowsTest,
    ::testing::Values(make_tuple(vector<size_t> { 3, 3, 3, 3 }, 0), make_tuple(vector<size_t> { 3, 3, 3, 3 }, 1),
                      make_tuple(vector<size_t> { 3, 3, 3, 3 }, 2), make_tuple(vector<size_t> { 3, 3, 3, 3 }, 3),
                      make_tuple(vector<size_t> { 3, 3, 3, 3 }, 4), make_tuple(vector<size_t> { 3, 3, 3, 3 }, 5),
                      make_tuple(vector<size_t> { 3, 3, 3 }, 6), make_tuple(vector<size_t> { 3, 3 }, 4)));
...
INSTANTIATE_TEST_SUITE_P(TensorSqueezeTests, SqueezeTest,
                         ::testing::Values(make_tuple(vector<size_t> { 1 }, 0, vector<size_t> {}),
